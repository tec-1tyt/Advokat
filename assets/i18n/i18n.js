...
(function () {
  ...
  var DICT = {
    uk: {
      ...
      'form.errSend': 'Не вдалося надіслати. Зателефонуйте: 068 726 38 33.',
    ...
    en: {
      ...
      'abroad.title': 'You are in Poland, Italy or Canada. The case is in Ukraine.',
      ...
      'form.okText': 'I will call you during working hours. If it is urgent, call 068 726 38 33.',
      ...
      'form.errSend': 'Couldn’t send the request. Call 068 726 38 33.',
